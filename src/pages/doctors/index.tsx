...
export function DoctorListPage(props: DoctorListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getDoctors({
        relations: ['organization', 'user', 'appointment.count', 'appointment_slot.count'],
  ...
  const columns: ColumnType[] = [
    ...
    hasAccess('appointment', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ...
      : null,
    hasAccess('appointment_slot', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          id: 'appointment_slot',
          header: 'Appointment Slot',
          accessorKey: 'appointment_slot',
          cell: ({ row: { original: record } }: any) => record?._count?.appointment_slot,
        }
      : null,
