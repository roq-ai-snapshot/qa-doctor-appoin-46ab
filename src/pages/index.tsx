  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="is your reliable partner in managing and scheduling medical appointments with efficiency and ease. Your health matters, let us handle the details."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`is your reliable partner in managing and scheduling medical appointments with efficiency and ease. Your health matters, let us handle the details.`}
            </Text>
            <Box
