...
import { getAppointmentSlotById } from 'apiSdk/appointment-slots';
import { AppointmentSlotInterface } from 'interfaces/appointment-slot';

function AppointmentSlotViewPage() {
      ...
      breadcrumbs={
        <Breadcrumbs
          items={[
            ...
            {
              label: 'Appointment Slot Details',
              isCurrent: true,
            },
          ]}
        />
            ...
            <FormWrapper wrapperProps={{ border: 'none', gap: 3, p: 0 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('appointment_slot', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/appointment-slots/edit/${id}`} passHref legacyBehavior>
                    <Button
